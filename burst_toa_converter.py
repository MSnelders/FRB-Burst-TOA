...
def options():
    ...
    general.add_argument('-DM_constant', type=np.float64, default=4.14880568679703,
                         help="The dispersion constant in units of GHz^2 cm^3 pc^-1 ms. Default: '4.14880568679703'")
